...
#### By the AWS Console (UI)

- Step 1: Login to the AWS Console
  - Log in to the [AWS Console](https://aws.amazon.com/console/)
  - In the search bar at the top, enter ECR and select [Elastic Container Registry](ttps://us-east-1.console.aws.amazon.com/ecr/private-registry/repositories)
