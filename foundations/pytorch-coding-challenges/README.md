...
The tasks were taken from: [TorchLeet / easy](https://github.com/Exorust/TorchLeet/tree/main/torch/easy) and [basic](https://github.com/Exorust/TorchLeet/tree/main/torch/basic)
