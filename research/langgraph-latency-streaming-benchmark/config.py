...
class Settings(BaseSettings):
    ...
    boto3_debug_logging: bool = Field(True, description="True if you want to see boto3 dubuging info.")
    asyncio_debug_logging: bool = Field(True, description="True if you want to see asyncio dubuging info.")
    urllib_debug_logging: bool = Field(True, description="True if you want to see urllib dubuging info.")
