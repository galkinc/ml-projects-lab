...
from src.utils import parse_chunk_content, get_report_path
...
async def run_langchain_aws_benchmark(
    ...
    logger.info(f"Starting LANGCHAIN-AWS benchmark. Samples: {len(all_prompts)}, Concurrency: {concurrency}")
...
if __name__ == "__main__":
    ...
    asyncio.run(run_langchain_aws_benchmark(
